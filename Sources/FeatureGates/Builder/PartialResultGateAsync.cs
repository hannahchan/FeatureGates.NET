...
/// <summary>Represents an incomplete asynchronous result gate, a feature gate that returns a result. Complete this gate by specifying a 'WhenClosed' delegate.</summary>
...
public class PartialResultGateAsync<TResult> : AbstractFeatureGate
{
    ...
    /// <summary>Gets the delegate to execute when 'ControlledBy' evaluates to <c>true</c>.</summary>
